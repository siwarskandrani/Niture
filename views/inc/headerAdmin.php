...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  ...
  <div class="navbar-nav">
    <div class="nav-item text-nowrap">
      <a class="nav-link px-3" href="deconnexionAdmin.php">Sign out</a>
    </div>
  </div>
</header>
      ...
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          <li class="nav-item">
            ...
            <li class="nav-item">
            <a class="nav-link" href="produitsAdmin.php">
              <span data-feather="shopping-cart" class="align-text-bottom"></span>
              Products
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="clientListe.php">
              <span data-feather="users" class="align-text-bottom"></span>
                Clients
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="liste_panier.php">
...
<!-- JavaScript pour rendre les liens de navigation actifs -->

<script>
  // Récupérer tous les liens de navigation
  const navLinks = document.querySelectorAll('.nav-link');

  // Parcourir tous les liens de navigation et ajouter un écouteur d'événements au clic
  navLinks.forEach(function(link) {
    link.addEventListener('click', function(event) {
      ...
      // Effectuer toute autre action souhaitée, comme la redirection vers la page appropriée
